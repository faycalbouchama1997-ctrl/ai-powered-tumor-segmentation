...
WEIGHTS_PATH = Path(__file__).parent.parent / "models" / "weights" / "segresnet.pth"
...
def predict(volume_dict: dict) -> Tuple[dict, bool]:
    ...
    if model is None:
        raise RuntimeError("SegResNet weights not found. Place segresnet.pth in models/weights/.")
